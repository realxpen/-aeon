...
import { searchMissionRequirements, searchCatalog, rankForMission, negotiate, Product, NegotiationResult, classifyMissionInput } from './marketplace'
...
export default function Mission(){
  ...
  const runMission=async()=>{
    ...
    try{
      ...
      if(found.length===0){const nearest=rankForMission(searchCatalog(missionGoal),priorities).slice(0,3);setProducts(nearest);throw Object.assign(new Error('NO_MATCHING_PRODUCTS'),{code:'UNAVAILABLE'})}
