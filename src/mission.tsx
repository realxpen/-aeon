...
export default function Mission(){
  ...
  const runMission=async()=>{
    ...
    try{
      ...
      setPhase('ANALYZING');await new Promise(r=>setTimeout(r,650))
      setPhase('NEGOTIATING');await new Promise(r=>setTimeout(r,650))
      ...
      setPhase('CONSTITUTION CHECK');await new Promise(r=>setTimeout(r,650))
