...
export default function Mission(){
  ...
  const chooseSurpriseCategory=(category:string)=>{const selected=surpriseCategories[category]??category;setGoal(`Find me a surprise ${selected} deal`);setInputIssue('');setError('');setProposal(null);setProducts([]);setApproved(false);setRunning(false);setPhase('SEARCHING');document.getElementById('goal')?.focus()}
