...
createRoot(document.getElementById('root')!).render(<React.StrictMode><RuntimeErrorState><App/><ThemeControl/><DemoMode/><JudgeBadge/></RuntimeErrorState></React.StrictMode>)